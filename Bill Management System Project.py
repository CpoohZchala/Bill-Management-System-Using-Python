...
class DCItem:
    def __init__(self, name, price, quantity, discount=0):
        # Initialize a new item with its name, price, quantity, and discount (defaulted to 0).
        self.name = name
        self.price = price
...
class DCBill:
    def __init__(self, cashier_name):
        # Initialize a new bill with the cashier's name, an empty list to store items, and the current date and time.
    ...
    def calculate_total(self):
        # Method to calculate the total cost of all items in the bill after applying discounts (if any).
        total = 0
    ...
    def print_bill(self, cash):
        # Method to print the bill with all the item details, total cost, cash payment, balance, and other information.
